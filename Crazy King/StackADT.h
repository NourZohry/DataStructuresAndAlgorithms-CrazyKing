...
public:
	...
	/** returns an array of pointers to constant objects
	@post sets size to size of the stack.
	@return  Array of pointers to const objects. If stack is empty, returns null.
	*/
	virtual const ItemType** toArray(int& size) const = 0;
